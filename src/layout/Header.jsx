...
const Header = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full py-5 px-2 lg:px-7 z-40">
      <div className="ml-0 lg:ml-[260px] rounded-md h-[65px] flex justify-between items-center bg-[#6457ee] bg-opacity-10 backdrop-filter backdrop-blur-lg bg-blur-lg px-5 transition-all">
        <div
        ...
        <div className="hidden md:block">
          <input
            className="px-3 py-2 outline-none border bg-transparent border-white-800 rounded-md text-[#ffffff] focus:border-indigo-500 overflow-hidden"
            type="text"
            name="search"
            placeholder="search"
          />
